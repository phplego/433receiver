...
void DubRtttl::stopTone() {
    melodyLoopCount = 0;
    melodyIdx = 0;
    melodyLoopCounter = 0;
}

void DubRtttl::getNextNote(){
...
void DubRtttl::playMelody() {
    ...
    tone(_buzzerPin, nextFrequency, nextDuration);
}

void DubRtttl::play(String songInPlay) {
    int num;
